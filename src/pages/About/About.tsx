  ...
  return (
    <>
      ...
      <p>
        ...
        experience working within Agile Development teams. My expertise focuses
        on developing and maintaining responsive web applications using the
      ...
      <p>
        Furthermore, my previous experience in public speaking equipped me with
        valuable soft skills and a passion for STEM subjects. During these talks
        I addressed audiences ranging from 300 to 5000 people and this provided
        me the ability to adjust how I present to suit the audience size and
